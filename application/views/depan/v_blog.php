                    ...
                    <article class="blog_item">
                        ...
                        <div class="blog_details">
                            ...
                            <ul class="blog-info-link">
                                <li><a href="#"><i class="fa fa-user"></i> <?php echo $row->tulisan_kategori_nama;?></a>
                                </li>
                                <li><a href="#"><i class="fa fa-comments"></i> <?php echo $row->tulisan_author;?></a>
                                </li>
                            </ul>
                        </div>
                    </article>
                ...
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget post_category_widget">
                        ...
                        <ul class="list cat-list">
                            ...
                            <li><a href="<?php echo site_url('blog/kategori/'.str_replace(" ","-",$row->kategori_nama));?>"
                                    class="d-flex"><?php echo $row->kategori_nama;?></a></li>
                            <?php endforeach;?>
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            <img width="35%" class="img-fluid"
                                src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt="post">
