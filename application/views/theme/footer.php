            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <img width="150" src="<?php echo base_url('');?>style/img/tut-wuri-handayani-7759.png"
                            class="rounded" alt="Muris Studio">
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <p>
                        ...
                        </script> <a href="about" target="_blank">SD Negeri 2 Rajawana </a>
                    </p>
                    </p>
                </div>
            </div>
